...
<body>
    ...
    {{-- sidebar --}}
    @include('masyarakat.components.layouts.sidebar')
    <section>
            ...
            <div class="relative overflow-x-auto mt-4">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <div class="flex justify-end items-center gap-2">
                        ...
                        @include('masyarakat.components.modals.artikel.tambahdata')
                        ...
                        @include('masyarakat.components.modals.artikel.sort')
                        @include('masyarakat.components.modals.artikel.search')
                    </div>
                    <thead
                    ...
                    <tbody>
                        ...
                        @include('masyarakat.components.modals.artikel.editdata')
                    </tbody>
                </table>
            </div>
            {{-- delete --}}
