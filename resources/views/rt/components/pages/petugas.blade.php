            ...
            <div class="relative overflow-x-auto mt-4 px-4">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <div class="flex justify-end items-center gap-2">
                        ...
                        @include('rt.components.modals.petugas.tambahdata')
                        ...
                        @include('rt.components.modals.petugas.sort')
                        @include('rt.components.modals.petugas.search')
                    </div>
                    @if (session('success'))
                            ...
                            <tr class="bg-white text-center border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center items-center space-x-2">
                                        ...
                                        <form action="{{ route('petugas.hapus.rt', $p->id) }}" method="POST"
                                    ...
                                    @include('rt.components.modals.petugas.editdata', [
                                        'petugas' => $p,
                                        'roles' => $roles,
                                    ])
                                </td>
