            ...
            <div class="relative overflow-x-auto mt-4 px-4">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <div class="flex justify-end items-center gap-2">
                        ...
                        @include('rt.components.modals.tanggapan.tambahdata')
                        ...
                        @include('rt.components.modals.tanggapan.sort')
                        @include('rt.components.modals.tanggapan.search')
                    </div>
                    <thead
                    ...
                    <tbody>
                        ...
                        @include('rt.components.modals.tanggapan.editdata')
                    </tbody>
                </table>
            </div>
            {{-- delete --}}
