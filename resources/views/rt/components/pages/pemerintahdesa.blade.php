...
<section>
    <div class="p-4 sm:ml-64">
        ...
        <div class="relative overflow-x-auto mt-4">
            <div class="flex justify-end items-center gap-2 mb-4">
                ...
                @include('rt.components.modals.pemerintahdesa.search')
            </div>
             @if (session('success'))
    ...
    <div class="flex justify-center items-center space-x-2">
        ...
        <form action="{{ route('pemerintah.hapus.rt', $pemerintahdesa->id) }}" method="POST">
            @csrf
            @method('DELETE')
...
@include('rt.components.modals.pemerintahdesa.tambahdata')
@foreach ($pemerintahdesas as $pemerintahdesa)
    @include('rt.components.modals.pemerintahdesa.editpemerintahdesa', ['pemerintahdesa' => $pemerintahdesa])
@endforeach
