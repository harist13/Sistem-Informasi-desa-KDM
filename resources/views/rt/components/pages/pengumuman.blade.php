                        ...
                        <tr class="bg-white text-center border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center space-x-2">
                                    ...
                                    <form action="{{ route('pengumuman.hapus.rt', $pengumuman->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
...
@include('rt.components.modals.pengumuman.tambah')
@foreach ($pengumumans as $pengumuman)
    @include('rt.components.modals.pengumuman.edit', ['pengumuman' => $pengumuman])
@endforeach
