...
<body>
                            ...
                            <tr class="bg-white text-center border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center items-center space-x-2">
                                        ...
                                        <form action="{{ route('artikel.hapus.rt', $artikel->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
    ...
    @include('rt.components.modals.artikel.tambahdata')
    @foreach ($artikels as $artikel)
        @include('rt.components.modals.artikel.editdata', ['artikel' => $artikel])
    @endforeach
