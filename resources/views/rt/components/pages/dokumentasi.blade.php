...
<body>
    ...
    <div class="flex justify-end items-center gap-2">
        ...
        @include('rt.components.modals.dokumentasi.tambahdata')
    </div>
     @if (session('success'))
    ...
    <div class="flex justify-center items-center space-x-2">
        ...
        <form action="{{ route('dokumentasi.hapus.rt', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus dokumentasi ini?');">
            @csrf
            @method('DELETE')
    ...
    @include('rt.components.modals.dokumentasi.editdata', ['dokumentasi' => $item])
@endforeach
        @endforeach
    </tbody>
</table>
