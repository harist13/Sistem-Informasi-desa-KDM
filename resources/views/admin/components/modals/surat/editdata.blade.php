                ...
                <form class="space-y-4" action="#">
                    <div>
                        <label for="jenis_surat"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Surat</label>
                        <input type="text" name="jenis_surat" id="jenis_surat"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            placeholder="A001" required />
                    </div>
                    <div>
                        <label for="tgl_pengajuan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="number" name="nik" id="nik" placeholder="Laptop"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            required />
                    </div>
                    <div>
