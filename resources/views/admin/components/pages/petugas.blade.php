    ...
    <div class="p-4 sm:ml-64">
        <div class="flex flex-col">
            ...
            <div class="flex justify-between items-center mb-2">
                <div class="p-3 mb-0 text-sm text-blue-800 rounded-lg lg:w-1/2 bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
    ...
    @endif
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center items-center space-x-2">
                                <button data-modal-target="edit-modal-{{ $p->id }}" data-modal-toggle="edit-modal-{{ $p->id }}" class="block text-white bg-yellow-300 hover:bg-yellow-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
                                    Edit
                                </button>
                                <form action="{{ route('petugas.hapus', $p->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this data?');">
                                    @csrf
                                    @method('DELETE')
                            ...
                            @include('admin.components.modals.petugas.editdata', ['petugas' => $p, 'roles' => $roles])
                        </td>
                    </tr>
                    @endforeach
                </tbody>
