    ...
    <section>
        <div class="p-4 sm:ml-64">
            <div class="flex flex-col">
                <h1 class="text-2xl lg:text-4xl font-bold mt-4 mb-2">Halaman Petugas</h1>
            ...
            <div class="relative overflow-x-auto mt-4 px-4">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <div class="flex justify-end items-center gap-2">
                        ...
                        @include('staff.components.modals.petugas.tambahdata')
                        ...
                        @include('staff.components.modals.petugas.sort')
                        @include('staff.components.modals.petugas.search')
                    </div>
                    @if (session('success'))
                            ...
                            <tr class="bg-white text-center border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center items-center space-x-2">
                                        ...
                                        <form action="{{ route('petugas.hapus.staff', $p->id) }}" method="POST"
                                    ...
                                    @include('staff.components.modals.petugas.editdata', [
                                        'petugas' => $p,
                                        'roles' => $roles,
                                    ])
                                </td>
