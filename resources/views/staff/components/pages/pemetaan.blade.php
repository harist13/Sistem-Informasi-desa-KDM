...
<head>
    ...
    <title>Dashboard Page | staffistrator & Staff</title>
    {{-- logo --}}
            ...
            <div class="flex flex-col">
                ...
                <div class="flex justify-between items-center mb-4">
                    <div class="p-3 mb-0 text-sm text-blue-800 rounded-lg lg:w-1/2 bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                        ...
                        <span class="font-medium">Dashboard</span> > Pemetaan > staffistrator / Staff
                    </div>
            ...
            <div class="relative overflow-x-auto mt-4 px-4">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <div class="flex justify-end items-center gap-2">
                        ...
                        @include('staff.components.modals.pemetaan.tambahdata')
                        ...
                        @include('staff.components.modals.pemetaan.sort')
                        @include('staff.components.modals.pemetaan.search')
                    </div>
                    <thead
                    ...
                    <tbody>
                        ...
                        @include('staff.components.modals.pemetaan.editdata')
                    </tbody>
                </table>
            </div>
            {{-- delete --}}
