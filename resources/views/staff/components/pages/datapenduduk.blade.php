            ...
            <div class="flex flex-col">
                ...
                <div class="flex justify-between items-center mb-2">
                    <div class="p-3 mb-0 text-sm text-blue-800 rounded-lg lg:w-full bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                        ...
                        <span class="font-medium">Dashboard</span> > Penduduk > staffistrator / Staff
                    </div>
                ...
                <div class="flex items-center justify-end gap-3 mt-3">
                    ...
                    @include('staff.components.modals.penduduk.tambahdata')
                    ...
                    @include('staff.components.modals.penduduk.sort')
                    <a href="{{ route('penduduk.export.staff') }}" class="block lg:w-1/6 my-2 lg:float-end text-white bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:focus:ring-yellow-800">
    Export to Excel
</a>

                    @include('staff.components.modals.penduduk.search')
