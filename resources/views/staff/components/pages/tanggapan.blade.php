            ...
            <div class="relative overflow-x-auto mt-4 px-4">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <div class="flex justify-end items-center gap-2">
                        ...
                        @include('staff.components.modals.tanggapan.tambahdata')
                        ...
                        @include('staff.components.modals.tanggapan.sort')
                        @include('staff.components.modals.tanggapan.search')
                    </div>
                    <thead
                    ...
                    <tbody>
                        ...
                        @include('staff.components.modals.tanggapan.editdata')
                    </tbody>
                </table>
            </div>
            {{-- delete --}}
