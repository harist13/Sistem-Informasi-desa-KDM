        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div>
                    ...
                    <p class="text-white text-[14px]">Berita Terkini</p>
                    <p class="text-white text-[14px]">Program Kerja</p>
                    <p class="text-white text-[14px]">Peraturan Desa</p>
                </div>
            </div>
        </div>
