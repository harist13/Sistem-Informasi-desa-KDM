 ...
 public function updateProfile(Request $request)
     ...
     public function importKependudukan(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kependudukan.staff')->with('success', 'Data penduduk berhasil diimpor.');
        } catch (\Exception $e) {
            return redirect()->route('kependudukan.staff')->with('error', 'Gagal mengimpor data: ' . $e->getMessage());
        }
    }
}
